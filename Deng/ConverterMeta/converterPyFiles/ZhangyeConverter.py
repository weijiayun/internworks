...
class ZhangyeConverter(object):
    ...
    def strategy_to_json(self, ZhangyeMeta):
        ...
        try:
            ...
            data_json['Instruments'] = generate_instruments(ZhangyeMeta, ZhangyeMeta.get_const_member_list)
            data_json['Ranges'] = generate_ranges(ZhangyeMeta, ZhangyeMeta.get_const_member_list)
