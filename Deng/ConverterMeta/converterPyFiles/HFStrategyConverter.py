...
class HFStrategyMeta(OrderedObject):
    ...
    def required_member_list(self):
        required_list=['Name', 'Type', 'MinMaxPositionChangePercent', 'XN', 'XD', 'EmitterType', 'Instruments_InstrumentName1', 'Instruments_IsConnect1', 'Instruments_Market1', 'Portfolio']
