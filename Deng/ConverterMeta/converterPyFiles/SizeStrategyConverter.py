...
class SizeStrategyConverter(object):
    ...
    def strategy_to_json(self, SizeStrategyMeta):
        ...
        try:
            ...
            data_json['Instruments'] = generate_instruments(SizeStrategyMeta, SizeStrategyMeta.get_const_member_list)
            data_json['Ranges'] = generate_ranges(SizeStrategyMeta, SizeStrategyMeta.get_const_member_list)
