...
class ZhongXingConverter(object):
    ...
    def strategy_to_json(self, ZhongXingMeta):
        ...
        try:
            ...
            data_json['Instruments'] = generate_instruments(ZhongXingMeta, ZhongXingMeta.get_const_member_list)
            data_json['Ranges'] = generate_ranges(ZhongXingMeta, ZhongXingMeta.get_const_member_list)
